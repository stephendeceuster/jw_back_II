...
class WoodCasesCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return WoodCases::class;
    }
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        $fields = [
            ...
            AssociationField::new('woodCasesCategories')->autocomplete()->onlyOnForms(),
            CollectionField::new('woodCasesCategories')->onlyOnIndex(),
            AssociationField::new('woodCasesTypes')->autocomplete()->onlyOnForms(),
            CollectionField::new('woodCasesTypes')->onlyOnIndex(),
